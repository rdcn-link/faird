...
public class MessageConfig {
    ...
    public static String LANGUAGE = LANGUAGE_TYPE_ZH;
    ...
    private static String INTERFACE_CALL_SUCCEEDED_FLOWS_NULL_ERROR_MSG;
    private static String INTERFACE_CALL_SUCCEEDED_FLOWS_NULL_ERROR_MSG_ZH;
    @Value("${msg.interface_call_succeeded_flows_null_error}")
    private void setInterfaceCallSucceededFlowsNullErrorMsg(String interfaceCallSucceededFlowsNullErrorMsg) {
        INTERFACE_CALL_SUCCEEDED_FLOWS_NULL_ERROR_MSG = interfaceCallSucceededFlowsNullErrorMsg;
    }
    @Value("${msg.interface_call_succeeded_flows_null_error.zh}")
    private void setInterfaceCallSucceededFlowsNullErrorMsgZh(String interfaceCallSucceededFlowsNullErrorMsgZh) {
        INTERFACE_CALL_SUCCEEDED_FLOWS_NULL_ERROR_MSG_ZH = interfaceCallSucceededFlowsNullErrorMsgZh;
    }
    public static String INTERFACE_CALL_SUCCEEDED_FLOWS_NULL_ERROR_MSG(){
        if(LANGUAGE_TYPE_ZH.equals(LANGUAGE)){
            return INTERFACE_CALL_SUCCEEDED_FLOWS_NULL_ERROR_MSG_ZH;
        }
        return INTERFACE_CALL_SUCCEEDED_FLOWS_NULL_ERROR_MSG;
    }
    ...
    private static String ACCESS_APPLY_SUCCESS_MSG;
    private static String ACCESS_APPLY_SUCCESS_MSG_ZH;
    @Value("${msg.access_apply_success_msg}")
    private void setAccessApplySuccessMsg(String accessApplySuccessMsg) {
        ACCESS_APPLY_SUCCESS_MSG = accessApplySuccessMsg;
    }
    @Value("${msg.access_apply_success_msg.zh}")
    private void setAccessApplySuccessMsgZh(String accessApplySuccessMsgZh) {
        ACCESS_APPLY_SUCCESS_MSG_ZH = accessApplySuccessMsgZh;
    }
    public static String ACCESS_APPLY_SUCCESS_MSG() {
        if(LANGUAGE_TYPE_ZH.equals(LANGUAGE)){
            return ACCESS_APPLY_SUCCESS_MSG_ZH;
        }
        return ACCESS_APPLY_SUCCESS_MSG;
    }
}